    ...
    if (this.state.hasError) {
      ...
      return (
        <div style={{ minHeight: '60vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 14, padding: '48px 24px', textAlign: 'center' }}>
          <h1 className="font-display" style={{ fontSize: 27, fontWeight: 500, letterSpacing: '-.02em', margin: 0 }}>
            {chunk ? 'A new version is available' : 'Something went wrong'}
          </h1>
          <p style={{ color: 'var(--text-muted)', fontSize: 15.5, maxWidth: '44ch', margin: 0, textAlign: 'center', lineHeight: 1.6 }}>
            {chunk
          ...
          <div style={{ display: 'flex', gap: 10, flexWrap: 'wrap', justifyContent: 'center', marginTop: 6 }}>
            <button
              ...
              style={{ padding: '11px 18px', background: 'var(--primary)', color: 'var(--on-primary)', border: 'none', borderRadius: 'var(--r-ctl)', fontWeight: 600, fontSize: 15, cursor: 'pointer', transition: 'background .18s ease' }}
            ...
            {!chunk && (
              <button
                ...
                style={{ padding: '11px 18px', background: 'var(--surface)', color: 'var(--text)', border: '1px solid var(--border)', borderRadius: 'var(--r-ctl)', fontWeight: 600, fontSize: 15, cursor: 'pointer', transition: 'background .18s ease' }}
